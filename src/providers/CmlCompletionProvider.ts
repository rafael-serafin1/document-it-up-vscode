...
export const cmlTagSuggestions: CmlTagSuggestion[] = [
  ...
  {
    label: 'throws',
    detail: 'List thrown exceptions',
    documentation: 'Lista as exceções que podem ser lançadas.',
    insertText: '<throws>$0</throws>'
  },
  {
    label: 'exception',
